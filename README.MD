...
1) Run `./gradlew :kexcel:publishToMavenLocal`
2) Open `~/.m2/repository/dev/shreyash/kexcel/`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :kexcel:publishAndReleaseToMavenCentral --no-configuration-cache`
